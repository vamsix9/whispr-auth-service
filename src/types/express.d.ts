...
import { operations } from './api-contract';

export type Mime = `${string}/${string}`;

export type Payload = {
  content?: Record<Mime, any>; // Make content optional
};
...
export type JsonOr<T extends Payload> =
  T extends JsonPayload<infer U> ? U : never;
